...
export const metadata = {
  title: 'Registration',
  description: 'Register your child at The Nurture Nest Multilingual Nursery. Registration for 2026 now open.',
};
      ...
      <div className="bg-slate-50 py-16 md:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-nest-600 text-white p-6 md:p-8 rounded-2xl mb-10">
            ...
            <p className="text-nest-100">Secure a place for your child. Give them the gift of an inclusive, nurturing start at The Nurture Nest.</p>
          </div>
