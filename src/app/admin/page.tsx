      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div className="w-20 h-20 rounded-full bg-white shadow-lg flex items-center justify-center mx-auto mb-4 overflow-hidden border-2 border-nest-100">
            <Image src="/logo-removebg-preview.png" alt="The Nurture Nest" width={60} height={60} className="object-contain" />
          </div>
          <h1 className="text-3xl font-display font-bold text-slate-900">Admin Panel</h1>
          <p className="text-slate-500 mt-1">The Nurture Nest Management Area</p>
        </div>
        ...
        <p className="text-center text-xs text-slate-400 mt-6">
          Protected admin area · The Nurture Nest Multilingual Nursery
        </p>
      </div>
    </div>
  );
