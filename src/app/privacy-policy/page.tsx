...
export const metadata = {
  ...
  description: 'Privacy policy for Nurture Nest Multilingual Nursery.',
};
    ...
    <PageLayout>
      <div className="bg-slate-50 py-16 md:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-slate-600 mb-10">Last updated: 2026. Nurture Nest (&quot;we&quot;, &quot;us&quot;) is committed to protecting your privacy.</p>
