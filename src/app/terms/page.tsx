...
export const metadata = {
  ...
  description: 'Terms of service for The Nurture Nest Multilingual Nursery.',
};
      ...
      <div className="bg-slate-50 py-16 md:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <section className="prose prose-slate max-w-none space-y-6 text-slate-600">
            ...
            <p>This website is for information about The Nurture Nest Multilingual Nursery. You may use it for lawful purposes only and must not misuse or attempt to gain unauthorised access to our systems or data.</p>
